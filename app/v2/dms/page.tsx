                  ...
                  <div className='flex w-full items-center justify-between'>
                    <div>
                      ...
                      <h1 className='text-gray-500'>
                        Chat privately with your friends and contacts
                      </h1>
                    </div>
                  ...
                  <div className='border-t border-gray-200 p-4 flex items-center'>
                    ...
                    <div className='px-2 w-full'>
                      <div className='flex justify-between w-full'>
                        <h1 className='text-gray-900 font-semibold'>Carlos</h1>
                        <h1 className='text-gray-500 text-xs'>2 hours ago</h1>
                      </div>
                      <h2 className='text-gray-500 text-sm'>Some Text Here</h2>
                    </div>
                  </div>{' '}
                  <div className='border-t border-gray-200 p-4 flex items-center'>
                    <div className='rounded-full h-10 w-10 bg-indigo-100 flex items-center justify-center'>
                      ...
                      >
                        <div className='flex items-center w-full'>
                          ...
                          <div className='flex-1 flex justify-between items-center'>
                            ...
                            <h1 className='text-indigo-600 py-1 px-3 bg-indigo-100 rounded-full'>
                              Add
                            </h1>
                          </div>
                        </div>
