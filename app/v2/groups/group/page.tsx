...
export default function ExactGroupPage() {
  const friends = [
    {
      id: '111',
      name: 'Carlos',
        ...
        <div className='flex h-full w-full flex-1'>
          <div className='flex-1 flex flex-col'>
            <div className='w-full bg-white p-4 flex items-center border-b border-gray-200'>
              ...
              <div className='px-2'>
                ...
                <h2 className='text-gray-500 text-sm'>some description</h2>
              </div>
            </div>
            <div className='flex flex-1 overflow-hidden'>
              <div className='flex flex-col h-full w-64 border-r border-gray-200 overflow-hidden'>
                <div className='flex-1 min-h-0 overflow-y-auto'>
                  <h1 className='p-4 text-gray-900 font-semibold border-b border-gray-200'>
                    GROUP CHANNELS
                  </h1>
                  <div className='p-4'>
                    <div className='flex bg-indigo-100 rounded-lg text-indigo-600 py-3 px-2'>
                      <Hash className='h-5 w-5' />
                      <h1 className='px-2'>general</h1>
                    </div>
                  </div>
                </div>
                <div className='border-t border-gray-200 p-4'>
                  <div className='flex items-center text-gray-500'>
                    ...
                    <h1 className='px-1'>Create channel</h1>
                  </div>
                </div>
              </div>
              ...
              <div className='flex-1 flex flex-col'>
                <div className='p-4 flex items-center border-b border-gray-200'>
                  ...
                  <h1 className='px-2 font-semibold text-gray-900'>general</h1>
                  <h1 className='px-2 text-gray-500'>
                    group description for general
                  </h1>
                </div>
                <div className='bg-gray-100 flex-1 p-4 overflow-y-auto space-y-3'>
                  <div className='flex'>
                    ...
                    <div className='bg-white rounded-lg ml-3 p-4'>
                      <div className='flex items-center'>
                        <h1 className='text-gray-900 font-semibold'>Alex</h1>
                        <h1 className='px-2 text-xs text-gray-500'>10:30 AM</h1>
                      </div>
                  ...
                  <div className='flex justify-end'>
                    <div className='bg-indigo-100 rounded-lg ml-3 p-4'>
                      <div className='flex items-center'>
                        <h1 className='text-gray-900 font-semibold'>You</h1>
                        <h1 className='px-2 text-xs text-gray-500'>10:30 AM</h1>
                      </div>
                      <h1 className='text-gray-900'>Has everyone finished</h1>
                    </div>
          ...
          <div className='border-l w-80 border-gray-200'>
            <div className='p-4 border-b border-gray-200'>
              <h1 className='font-bold text-gray-900'>Members - 15</h1>
            </div>
            ...
            <div className='p-4'>
              <h1 className='text-gray-900 font-semibold'>Group Actions</h1>
